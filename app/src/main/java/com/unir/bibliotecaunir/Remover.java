...
public class Remover extends AppCompatActivity {
    ...
    private TableLayout tabelaRemove;
    private Button btn_remover_entrada;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabelaRemove = findViewById(R.id.tb_pesquisaAtualizar);
        ...
        if (lista != null && lista.size() > 0){
            for (ContentValues cv : lista){
                ...
                tabelaRemove.addView(tr);
            }
        }

        btn_remover_entrada.setOnClickListener(new View.OnClickListener() {
            @Override
